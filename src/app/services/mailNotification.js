...
module.exports = {
  welcomeMail: async (details) => {
    const html = `<div> \r\n<p>Hello,<\/p>\r\n\r\n<p> Welcome to Gurubox. <\/p>\r\n\r\n<p>You recently created a Gurubox Account. <\/p>\r\n\r\n<p>Your Gurubox Registered Mail is: <b>${details.email} <\/b><\/p>\r\n\r\n<p><\/br>Thanks,<\/p>\r\n\r\n<p><b>The Gurubox Account Team<\/b><\/p>\r\n<\/div>`;
    await sendMail(details.email, "Welcome to Gurubox", html);
  },
  sendOTPmail: async ({ email, code }) => {
    try {
      const html = `<div> \r\n<p>Password Reset Instructions<\/p>\r\n\r\n<p>Your Gurubox One-Time password reset code is: ${code}. Enter online when prompted. This passcode will expire in 5 minutes<\/p><\/br>Thank you for updating your password.<\/p>\r\n\r\n<p><b>Gurubox<\/b><\/p>\r\n<\/div>`;
